...
class Model(object):
    def __init__(self, ctx='cpu', file=None):
        ...
        with self.net.name_scope():
            self.net.add(
                nn.Conv2D(64, kernel_size=(7,7), padding=(3,3), activation='relu'),
                nn.Conv2D(64, kernel_size=(1,1), activation='relu'),
                nn.Conv2D(64, kernel_size=(1,1), activation='relu'),
                nn.MaxPool2D(pool_size=(2,2), strides=(2,2)),

                nn.Conv2D(96, kernel_size=(5,5), padding=(2,2), activation='relu'),
                nn.Conv2D(96, kernel_size=(1,1), activation='relu'),
                nn.Conv2D(96, kernel_size=(1,1), activation='relu'),
                nn.MaxPool2D(pool_size=(2,2), strides=(2,2)),

                nn.Conv2D(128, kernel_size=(3,3), padding=(1,1), activation='relu'),
                nn.Conv2D(128, kernel_size=(1,1), activation='relu'),
                nn.Conv2D(128, kernel_size=(1,1), activation='relu'),
                nn.MaxPool2D(pool_size=(2,2), strides=(2,2)),

                nn.Dropout(0.5),

                nn.Conv2D(10, kernel_size=(3,3), padding=(1,1), activation='relu'),
                nn.Conv2D(10, kernel_size=(1,1), activation='relu'),
                nn.Conv2D(10, kernel_size=(1,1), activation='relu'),
